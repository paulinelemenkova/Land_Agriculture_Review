...
\Author{Polina Lemenkova $^{1,2,3}$*\orcidA{}}
...
$^{3}$ \quad La Technopole d'Orl\'eans. 1 avenue du Champ de Mars, 45100 Orl\'eans, France.
}
...
\begin{tabularx}{\textwidth}{p{1.0cm} p{1.5cm} p{2.5cm} p{3.5cm} p{3.5cm}}
\hline
\textbf{Era} & \textbf{Modelling Approach} & \textbf{Representative Models} & \textbf{Strengths} & \textbf{Limitations} \\
\toprule
1950s--1980s &
...
\setcounter{table}{1}
\begin{longtable}{p{1.5cm} p{3cm} p{4.0cm} p{4.0cm}}
...
\begin{longtable}{p{1.8cm} p{1.5cm} p{3.0cm} p{3.0cm} p{3.0cm}}
