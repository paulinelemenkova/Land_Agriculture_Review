...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Global overview of water scarcity and agricultural water demand under climate change scenarios. Diagram source: author.}
    \label{fig01}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Conceptual diagram scheme of soil--water interaction processes in agricultural systems. Diagram source: author.}
    \label{fig02}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Taxonomy of AI methods applied in soil-water and agricultural systems. Diagram source: author.}
    \label{fig04}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Deep learning architectures for spatiotemporal soil moisture prediction. Diagram source: author.}
    \label{fig05}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Architecture of distributed deep learning and federated learning in smart agriculture. Diagram source: author.}
    \label{fig06}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Explainable AI framework for agricultural decision support. Diagram source: author.}
    \label{fig08}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Future ecosystem of AI-enabled sustainable agriculture. Diagram source: author.}
    \label{fig09}
\end{figure}
